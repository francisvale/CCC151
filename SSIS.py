...
title_label = Label(root, text="Student  Information  System", font=("Impact", 20), fg="#800000", bg="#F0E68C")
title_label.grid(row=0, column=0, columnspan=3, padx=10, ipadx=50)

# Make a frame for search and Title
srch = Frame(root, bg="#F0E68C")
...
search_btn = Button(srch, text="Search ID Number", bg="#DAA520", command=searchb)
search_btn.grid(row=0, column=4, ipadx=10)

# Entries Frame
leftside = Frame(root, bg="#F0E68C")
leftside.grid(row=1, column=1, padx=10)

rightSide = Frame(root, bg="#F0E68C")
rightSide.grid(row=2, column=3, columnspan=3, padx=10, sticky='w')

# Labels
il = Label(leftside, text="ID Number", bg="#F0E68C")
il.grid(row=1, column=0, sticky='w', padx=5)
nl = Label(leftside, text="Name", bg="#F0E68C")
nl.grid(row=2, column=0, sticky='w', padx=5)
cl = Label(leftside, text="Course", bg="#F0E68C")
cl.grid(row=3, column=0, sticky='w', padx=5)
yl = Label(leftside, text="Year Level", bg="#F0E68C")
yl.grid(row=4, column=0, sticky='w', padx=5)
gl = Label(leftside, text="Gender", bg="#F0E68C")
gl.grid(row=5, column=0, sticky='w', padx=5)

# Lower Labels
cc = Label(rightSide, text='Course Code', bg='#F0E68C')
cc.grid(row=1, column=0, sticky='w', padx=5)
cn = Label(rightSide, text='Course Name', bg='#F0E68C')
...
# rightSide buttons
add_btn2 = Button(rightSide, text="Add", bg="#DAA520", command=add2, width=7)
add_btn2.grid(row=1, column=2, sticky='e', pady=3, padx=10)

del_btn2 = Button(rightSide, text="Delete", bg="#DAA520", command=delete2, width=7)
del_btn2.grid(row=2, column=2, sticky='e', pady=3, padx=10)

mod_btn2 = Button(rightSide, text="Modify", bg="#DAA520", command=modify2, width=7)
mod_btn2.grid(row=1, column=3, pady=3, padx=10)

clr_btn2 = Button(rightSide, text="Clear", bg="#DAA520", command=clear2, width=7)
...
search_btn2 = Button(rightSide, text="Search by Course Code", bg="#DAA520", command=search2b)
search_btn2.grid(row=0, column=2, columnspan=2, ipadx=10, sticky='e')

# Buttons Left_side
# columnspan=2, ipadx=10,

add_btn = Button(leftside, text="Add", bg="#DAA520", command=add, width=7)
add_btn.grid(row=6, column=0, sticky='e', pady=3)

del_btn = Button(leftside, text="Delete", bg="#DAA520", command=delete, width=7)
del_btn.grid(row=7, column=0, sticky='e', pady=3)

mod_btn = Button(leftside, text="Modify", bg="#DAA520", command=modify, width=7)
mod_btn.grid(row=6, column=1, pady=3)

clr_btn = Button(leftside, text="Clear", bg="#DAA520", command=clear, width=7)
